 ...
 * <p><code>com.github.lkq.timeron.thirdparty.cglib.Foo$$EnhancerByCGLIB$$38272841</code><p>
...
public class DefaultNamingPolicy implements NamingPolicy {
     ...
     */
    private final static boolean STRESS_HASH_CODE = Boolean.getBoolean("com.github.lkq.timeron.thirdparty.cglib.test.stressHashCodes");
    
    public String getClassName(String prefix, String source, Object key, Predicate names) {
        if (prefix == null) {
            prefix = "com.github.lkq.timeron.thirdparty.cglib.empty.Object";
