...
import com.github.lkq.timeron.thirdparty.objenesis.instantiator.android.AndroidSerializationInstantiator;
import com.github.lkq.timeron.thirdparty.objenesis.instantiator.basic.ObjectStreamClassInstantiator;
import com.github.lkq.timeron.thirdparty.objenesis.instantiator.basic.ObjectInputStreamInstantiator;
import com.github.lkq.timeron.thirdparty.objenesis.instantiator.gcj.GCJSerializationInstantiator;
import com.github.lkq.timeron.thirdparty.objenesis.instantiator.perc.PercSerializationInstantiator;
...
public class SerializingInstantiatorStrategy extends BaseInstantiatorStrategy {
   ...
   public <T> ObjectInstantiator<T> newInstantiatorOf(Class<T> type) {
      ...
      if(PlatformDescription.JVM_NAME.startsWith(PlatformDescription.HOTSPOT) || PlatformDescription.isThisJVM(PlatformDescription.OPENJDK)) {
