...
class BulkBeanEmitter extends ClassEmitter {
    ...
    private static final Type BULK_BEAN =
      TypeUtils.parseType("com.github.lkq.timeron.thirdparty.cglib.beans.BulkBean");
    private static final Type BULK_BEAN_EXCEPTION =
      TypeUtils.parseType("com.github.lkq.timeron.thirdparty.cglib.beans.BulkBeanException");
