...
class DispatcherGenerator implements CallbackGenerator {
    ...
    private static final Type DISPATCHER =
      TypeUtils.parseType("com.github.lkq.timeron.thirdparty.cglib.proxy.Dispatcher");
    private static final Type PROXY_REF_DISPATCHER =
      TypeUtils.parseType("com.github.lkq.timeron.thirdparty.cglib.proxy.ProxyRefDispatcher");
