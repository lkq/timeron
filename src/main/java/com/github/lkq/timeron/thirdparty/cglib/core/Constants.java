 ...
 */
public interface Constants extends com.github.lkq.timeron.thirdparty.asm.Opcodes {
    ...
    public static final Type TYPE_SIGNATURE = TypeUtils.parseType("com.github.lkq.timeron.thirdparty.cglib.core.Signature");
