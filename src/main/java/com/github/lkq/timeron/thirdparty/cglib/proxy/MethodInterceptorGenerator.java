...
implements CallbackGenerator
{
    ...
    private static final Type REFLECT_UTILS =
      TypeUtils.parseType("com.github.lkq.timeron.thirdparty.cglib.core.ReflectUtils");
    private static final Type METHOD_PROXY =
      TypeUtils.parseType("com.github.lkq.timeron.thirdparty.cglib.proxy.MethodProxy");
    private static final Type METHOD_INTERCEPTOR =
      TypeUtils.parseType("com.github.lkq.timeron.thirdparty.cglib.proxy.MethodInterceptor");
